...
public class Transformer {
    ...
    public static String toString(Expr expr) {
        return switch (expr) {
            ...
            case Pow(var lhs, var rhs) ->
                    conditionalParens(lhs, add_sub_mul_div_pow) + "^" + conditionalParens(rhs, add_sub_mul_div_pow);
            case Func(var name, var args) ->
                    name + "(" + String.join(", ", args.stream().map(Transformer::toString).toList()) + ")";
